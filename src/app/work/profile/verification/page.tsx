...
export default function WorkerVerificationPage() {
  ...
  // Form data for Business level (Worker might not need this, but keeping for consistency)
        ...
        <Section spacing="lg" className="animate-fade-in">
          ...
          <VStack gap={2}>
            <HStack gap={3} align="center" className="text-3xl font-bold text-brand-text-dark tracking-tight">
              <Link href="/work/profile" className="text-brand-text-light hover:text-brand-text-dark">
            ...
            <p className="text-brand-text-light text-lg">
              ยืนยันตัวตนเพื่อเพิ่มวงเงินการถอน
            </p>
          </VStack>

          <div className="max-w-2xl mx-auto space-y-6">
            {/* Current Level Card */}
            <Card variant="elevated" className="border-none shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              {/* Business Level - Optional for workers */}
              <Card 
                variant="bordered"
                className={`p-5 transition-all ${
                  currentLevel === 'business' 
                    ...
                    : currentLevel === 'verified'
                      ? 'hover:border-brand-primary hover:shadow-md cursor-pointer'
                      : 'bg-brand-bg/50 cursor-not-allowed opacity-60'
                }`}
        ...
        <Section spacing="lg" className="animate-fade-in">
          <VStack gap={2}>
            <HStack gap={3} align="center" className="text-3xl font-bold text-brand-text-dark tracking-tight">
              ...
              <span className="p-2.5 bg-purple-100 rounded-xl">
