  ...
  return (
    <label className={cn("inline-flex items-center gap-2 cursor-pointer", disabled && "opacity-50 cursor-not-allowed", className)}>
      <input
        ...
        disabled={disabled}
        className="w-4 h-4 rounded border-gray-300 text-brand-primary focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 cursor-pointer disabled:cursor-not-allowed"
      />
      {label && (
